...
-- Date: 22.04.2018 --
--------------------------------------------------------------------------------
with Data, Ada.Text_IO, Ada.Integer_Text_IO, Ada.Float_Text_IO, Ada.Synchronous_Task_Control, Ada.Numerics.Generic_Elementary_Functions, Ada.Calendar;
use Ada.Text_IO, Ada.Integer_Text_IO, Ada.Float_Text_IO, Ada.Synchronous_Task_Control, Ada.Numerics.Generic_Elementary_Functions, Ada.Calendar;

procedure CourseWork is
	
	STORAGE : constant Integer := 50000000;
	POWER : constant Integer := 3;         -- power of 2 
	N : constant Integer := 2**POWER;      -- size of vector and matrix 
	P : constant Integer := 8;             -- amount of the processors
	...
	--type TiPtr is access Ti;
	--type TiPtr_array is array (1..P) of TiPtr;
	--tasks : TiPtr_Array;
